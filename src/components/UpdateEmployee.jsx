    ...
    <div className='max-w-xl mx-40 bg-slate-800 my-20 rounded shadow py-4 px-8'>
     ...
     <div className='mx-10 my-2'>
        ...
        onChange={(e) => handleChange(e)}
         className=" w-full py-2 my-2 text-slate-800 " placeholder='Name'></input>
        <input 
        type='number'
        name ='phone'
        value = {employee.phone}
        onChange={(e) => handleChange(e)}
        className=" w-full py-2 my-2 text-slate-800 " placeholder='phone'></input>
        <input 
         type ='email'
         name='email'
         value = {employee.email}
         onChange={(e) => handleChange(e)}
        className=" w-full py-2 my-2 text-slate-800 " placeholder='Email'></input>
